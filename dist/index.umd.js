(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash-es/assign'), require('lodash-es/forEach'), require('lodash-es/isFunction'), require('lodash-es/isNumber')) :
  typeof define === 'function' && define.amd ? define(['exports', 'lodash-es/assign', 'lodash-es/forEach', 'lodash-es/isFunction', 'lodash-es/isNumber'], factory) :
  (factory((global.canvas = global.canvas || {}),global.assign,global.forEach,global.isFunction,global.isNumber));
}(this, (function (exports,assign,forEach,isFunction,isNumber) { 'use strict';
